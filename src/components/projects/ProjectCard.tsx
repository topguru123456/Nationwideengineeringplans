  ...
  if (variant === "panel") {
    return (
      <article className="group/card relative flex h-full flex-col overflow-hidden rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] shadow-sm transition duration-300 ease-out hover:-translate-y-1.5 hover:border-neutral-300 hover:shadow-2xl hover:ring-2 hover:ring-[var(--brand-red)]/20 active:translate-y-0 active:transition-none">
        ...
        >
          <div className="relative aspect-[3/2] w-full bg-neutral-200">
            <Image
        ...
        <div className="flex flex-1 flex-col p-5">
          <p className="text-xs font-bold uppercase tracking-wide text-[var(--color-ink-faint)]">
            {project.location}
          </p>
          ...
          <Link
            href={`/projects/${project.slug}`}
            className="mt-4 inline-flex w-fit items-center gap-1.5 text-sm font-bold text-[var(--brand-red)] underline-offset-4 transition hover:gap-2 hover:underline"
          >
            Read more
